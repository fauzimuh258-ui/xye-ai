...
const PLACEHOLDER: Record<Mode, string> = {
  ...
  PROMPT_ENGINEER: 'Describe the task and target AI/model, e.g. "a prompt for classifying support tickets by urgency"...',
};
    ...
    <div className="flex h-full flex-col gap-3">
      ...
      <div className="flex items-center justify-between">
        ...
        {isStreaming ? (
          ...
          <Button onClick={onSubmit} disabled={!value.trim()}>Run {mode}</Button>
        )}
      </div>
    </div>
  );
